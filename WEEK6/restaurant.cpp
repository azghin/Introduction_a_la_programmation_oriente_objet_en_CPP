...
{
    if (this->getNom() == nomProduit) return 1; // or return the actual quantity for this product
    else return 0;
}
};
...
int main()
{
	...
	ProduitCuisine glacage("gla�age au chocolat");
	// recette pour une portion de gla�age:
	...
	ProduitCuisine glacageParfume("gla�age au chocolat parfum�");
	// besoin de 1 portions de gla�age au chocolat et de 2 gouttes
	// d'extrait d'amandes pour 1 portion de gla�age parfum�

	glacageParfume.ajouterARecette(extraitAmandes, 2);
	glacageParfume.ajouterARecette(glacage, 1);
	cout << glacageParfume.toString() << endl;

	Recette recette("tourte glac�e au chocolat");
	...
	cout << "===========================\n" << endl;
	cout << "V�rification que le gla�age n'a pas �t� modifi� :\n";
	cout << glacage.toString() << endl;
